...
public class UpdateControllerTest {
    /** Servlet under test. */
    private UpdateController servlet;
    ...
    public void doPost() throws Exception {
        ...
        parameters.put("status","add");
        parameters.put("name","UpdateTestUser");

        servlet.doPost(request,response);
        User findUser = UserStore.getInstance().getUserByLogin("TestUser");

        assertTrue("UpdateTestUser".equals(findUser.getName().trim()));
