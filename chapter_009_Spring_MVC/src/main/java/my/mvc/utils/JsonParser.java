...
import my.mvc.presentation.UploadServlet;
...
/**
 * Created by Ivan Sliusar on 21.06.2018.
 * Red Line Soft corp.
 */
public class JsonParser {
    ...
    static {
        ...
        DEFAULT_SERIALIZER = new JsonParser(mapper);
    }
    // {{end:setup}}
    ...
    private JsonParser(ObjectMapper mapper) {
        this.mapper = mapper;
